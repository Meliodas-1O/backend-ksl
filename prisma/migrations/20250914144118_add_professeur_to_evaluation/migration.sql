/*
  ...
  - Added the required column `professeurId` to the `Evaluation` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Evaluation" ("classeId", "createdAt", "date", "description", "disciplineId", "id", "schoolId", "title") SELECT "classeId", "createdAt", "date", "description", "disciplineId", "id", "schoolId", "title" FROM "Evaluation";
