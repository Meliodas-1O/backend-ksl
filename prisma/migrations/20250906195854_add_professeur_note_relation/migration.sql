/*
  ...
  - Added the required column `professeurId` to the `Note` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Note" ("appreciation", "classeId", "coefficient", "createdAt", "date", "devoir", "disciplineId", "id", "note", "schoolId", "studentId", "type") SELECT "appreciation", "classeId", "coefficient", "createdAt", "date", "devoir", "disciplineId", "id", "note", "schoolId", "studentId", "type" FROM "Note";
DROP TABLE "Note";
